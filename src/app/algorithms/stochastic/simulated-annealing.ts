...
export class SimulatedAnnealingRunner implements AlgorithmRunner {
  ...
  private readonly initialTemp = 5; // Start-Temperatur (in "Kosten-Einheiten", z.B. Meter)
  private readonly coolingFactor = 0.99; // Abkühlung pro Schritt
  private readonly minTemp = 2.5; // Wenn T hierunter fällt, verhalten wir uns fast wie Greedy
